...
namespace CreditDemo.Migrations
{
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<string>(maxLength: 12, nullable: false, defaultValueSql: "NEXT VALUE FOR DBSequence"),
                    ...
                    OperatorName = table.Column<string>(maxLength: 500, nullable: false),
                    OpeningDebit = table.Column<double>(nullable: false),
                    Currency = table.Column<string>(maxLength: 50, nullable: true),
                    SaleInvoiceNumber = table.Column<string>(maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
